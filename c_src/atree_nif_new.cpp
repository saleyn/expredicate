...
// Resource type for ExpressionEngine
...
// Store unique_ptr to ExpressionEngineInterface - Erlang resource manages lifetime
...
/**
 * Destructor for ExpressionEngine resource
 */
...
/**
 * Parse engine option from Elixir map
 * Options map: #{engine: :parser | :bytecode}
 */
 ...
 * Elixir: new() or new(engine: :bytecode)
 */
 ...
 * atree_nif:match(Tree, ValueMap) -> [ItemIds]
 */
